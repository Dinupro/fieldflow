...
const getClientConfig = (options, loadEnv)=>{
    ...
    const hydrateSession = (sessionData)=>{
        ...
        hasHydrated = true;
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$better$2d$auth$2f$dist$2f$client$2f$session$2d$atom$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["hydrateSessionAtom"])(session, sessionData);
    };
...
__turbopack_context__.s([
    "createAuthClient",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$better$2d$auth$2f$dist$2f$client$2f$react$2f$index$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$locals$3e$__["createAuthClient"],
    "useStore",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$better$2d$auth$2f$dist$2f$client$2f$react$2f$react$2d$store$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useStore"]
]);
...
function createAuthClient(options) {
    const { pluginPathMethods, pluginsActions, pluginsAtoms, hydrateSession, $fetch, $store, atomListeners } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$better$2d$auth$2f$dist$2f$client$2f$config$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["getClientConfig"])(options);
    const resolvedHooks = {};
...
const SESSION_MOUNT_DEDUPE_INTERVAL = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$nanostores$2f$lifecycle$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["STORE_UNMOUNT_DELAY"];
...
"[project]/node_modules/nanostores/deep-map/path.js [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function getKeyAndIndicesFromKey(key) {
    if (ARRAY_INDEX.test(key)) {
        ...
        return [
            ...getKeyAndIndicesFromKey(keyPart),
            index
        ];
    }
    return [
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$nanostores$2f$deep$2d$map$2f$path$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/nanostores/deep-map/path.js [app-ssr] (ecmascript)");
;
function listenKeys($store, keys, listener) {
    let keysSet = new Set(keys);
    return $store.listen((value, oldValue, changed)=>{
        if (changed === undefined ? keys.some((key)=>oldValue === undefined || // `map` keys are plain properties, but a `deepMap` key is a path into
            // the value, where a plain lookup would compare undefined to undefined
            // and never report a change.
            value[key] !== oldValue[key] || (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$nanostores$2f$deep$2d$map$2f$path$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["getPath"])(value, key) !== (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$nanostores$2f$deep$2d$map$2f$path$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["getPath"])(oldValue, key)) : keysSet.has(changed) || keysSet.has(changed.split(/\.|\[/)[0])) {
...
//# sourceMappingURL=node_modules_1810dmd._.js.map