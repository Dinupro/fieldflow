      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 bg-linear-to-r from-slate-900 via-slate-800 to-indigo-950 p-6 sm:p-8 rounded-3xl text-white shadow-xl shadow-slate-950/10 border border-slate-700/60 relative overflow-hidden">
        ...
        <div className="flex items-center gap-3 relative z-10 shrink-0">
          ...
          <button
            ...
            className="flex items-center gap-2 px-4 py-2.5 rounded-xl bg-linear-to-r from-blue-600 to-indigo-600 hover:from-blue-500 hover:to-indigo-500 text-white text-xs font-bold transition-all cursor-pointer shadow-md shadow-blue-600/25 active:scale-95 disabled:opacity-50"
          >
            ...
            <div className="hidden xl:flex items-center gap-1.5 ml-2">
              {["ALL", "WORK_ORDER", "CUSTOMER", "TECHNICIAN", "USER"].map((tab) => (
                <button
                  ...
                  className={`px-2.5 py-1 rounded-lg text-[11px] font-bold transition-all cursor-pointer ${entityType === tab
                    ...
                    >
                      ...
                      <td className="py-4 px-4 align-top min-w-48">
                        <div className="flex items-center gap-2.5">
                          <div className="w-8 h-8 rounded-xl bg-linear-to-tr from-slate-700 to-indigo-800 text-white flex items-center justify-center font-bold text-xs shrink-0 shadow-xs">
                          ...
                          <div className="flex flex-col min-w-0">
                            ...
                            <div className="flex items-center gap-1 mt-0.5">
                              <span
                                className={`text-[10px] font-bold px-1.5 py-0.2 rounded border ${log.userRole === "ADMIN"
