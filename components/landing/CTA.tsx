...
export default function CTA() {
  return (
    <section className="py-20 bg-slate-900 text-white relative overflow-hidden">
      ...
      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[800px] h-[400px] bg-gradient-to-tr from-blue-600/30 via-indigo-600/30 to-cyan-500/20 rounded-full blur-3xl pointer-events-none" />
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="rounded-3xl bg-gradient-to-b from-slate-800/90 to-slate-900/95 border border-slate-700/80 p-8 sm:p-12 lg:p-16 shadow-2xl text-center space-y-8 max-w-5xl mx-auto">
          {/* Top Pill */}
