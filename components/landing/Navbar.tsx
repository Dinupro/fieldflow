      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between">
          ...
          <div className="hidden sm:flex items-center gap-3">
            ...
            >
              <span className="w-full h-full bg-gradient-to-r from-blue-600 to-indigo-600 group-hover:from-blue-700 group-hover:to-indigo-700 text-white text-sm px-4 py-2 rounded-[10px] flex items-center gap-1.5 transition-all">
